...
export default function DashboardPage() {
  ...
  if (status === "loading" || loading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundImage: "url('/home-bg-weblom.jpg')", backgroundSize: "cover", backgroundPosition: "top center" }}>
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/home-bg-weblom.jpg')",
